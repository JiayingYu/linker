...
//	
//	
//	private void readDefList(ObjectModule module, int baseAddress) {
...
//	}
//	
//	private void readUseList(ObjectModule module) {
...
//	}
//	
//	private void readProgramText(ObjectModule module) {
...
public class Linker {
	...
	private void readDefList(ObjectModule module, int baseAddress) throws SyntaxException {
		...
		if (scanner.hasNextInt()) {
			...
			throw new SyntaxException("Number expected");
		}
		...
		for (int i = 0; i < defCount; i++) {
			...
			try {
				...
				throw new SyntaxException("Address expected");
			}
	...
	private void readProgramText(ObjectModule module) throws SyntaxException {
		...
		if (scanner.hasNext("[^(EOL)]") && scanner.hasNext("R|I|E|A")) {
			throw new SyntaxException("too many instr in module");
		}
	}
